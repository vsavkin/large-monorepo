...
## Benchmark & Results (March 10th, 2026)
...
- **average lage time is: 1619.3**
- **average turbo time is: 935.1**
- **average nx time is: 324.6**
- **nx is 4.99x faster than lage**
- **nx is 2.88x faster than turbo**
