...
## Benchmark & Results (May 8th, 2026, Nx 22.7)
...
- **average lage time is: 1149.2**
- **average turbo time is: 534.7**
- **average nx time is: 401.3**
- **nx is 2.86x faster than lage**
- **nx is 1.33x faster than turbo**
